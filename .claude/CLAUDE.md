...
| 제품 | 정체 | 배포 |
|---|---|---|
| **AI Observer** | 기업 AI 사용 로그 + 거버넌스 + 코칭 | SaaS (프록시/익스텐션) |
| **LucaPus** | CLI 설치 AI 개발 엔진 (4-Plane + 3 Orchestrators) | 고객 환경 설치 |
| **Wiring AI** | AI 개발팀 가시화 웹 UI (HITL + 파이프라인 + 적합화) | SaaS |

AI Observer는 Wiring 내장 모듈이자 단독 제품. LucaPus는 Wiring의 백엔드 엔진. 상세는 `rules/01_product.md`.
...
| 축 | 값 | 감지 | 불확실 시 |
|---|---|---|---|
| 제품 | AI Observer / LucaPus / Wiring / 연동 | 파일 경로, 키워드 | `/gz-scope product` |
...
| "연동", "~에 연결", "~와 통신", "AI Observer↔Wiring" | **I** (Integration) | `90_execution_chain.md § I` |
...
| 작업이 이것에 관련되면 | 추가 로드 |
|---|---|
| AI Observer (프록시/로그/익스텐션/거버넌스) | `products/aiops/CLAUDE.md` |
...
| `/gz-impact <변경대상>` | 제품 간 임팩트 분석 (AI Observer↔Wiring↔LucaPus) | `commands/gz-impact.md` |
