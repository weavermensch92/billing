...
> Wiring 글래스모피즘 (PW-001) / AI Observer 대시보드 (PA-001) / 공통 컴포넌트.
...
- AI Observer 데모 프론트: `Gridge_Logging_System___데모_프론트_개발_프롬프트.md` (프로젝트 knowledge)
