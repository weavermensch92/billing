...
- `[S] AI Observer logs 테이블에 tenant_id 추가`
- `[I] AI Observer → Wiring 로그 파이프라인 v2`
...
| AI Observer 프록시 | AI Observer L3 1명 | — |
...
|---|---|---|
| AI Observer 프록시 | 80% | 100% (로그 유실 방지) |
| AI Observer 대시보드 | 60% | 80% |
...
### Changed
- AI Observer 프록시 응답 포맷 개선 (PA-002)
